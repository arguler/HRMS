...
public class APIWorkFlowSteps {
    ...
    @Then("the status code for creating-updating an employee is {int}")
    public void the_status_code_for_creating_updating_an_employee_is(int statusCode) {
...
//-----------------------------------------------------------------------------------------
    ...
    public void a_request_is_prepared_for_updating_an_employee_with_data(String empId, String fn, String ln, String mn,
    ...
    request = given().header(APIConstants.HEADER_CONTENT_TYPE_KEY,
                ...
                header(APIConstants.HEADER_AUTHORIZATION_KEY, GenerateTokenStep.token).
                body(APIPayloadConstants.
                        updateEmployeeJsonPayloadDynamic
                                (empId, fn, ln, mn, gender, dob, status, jobTitle));
    }
